...
from src.external import ivector as iv, energy_vad as evad, gmm, ivector_io as ivio, features
...
for ii, fn in enumerate(seg_list, 1):
    try:
        ...
        if os.path.isfile(wav_file):
            print('  Reading wave file from ' + wav_file, end=' ')
            ...
            print('  Reading raw 8000Hz, 16bit-s, 1c,  file from ' + raw_file, end=' ')
        ...
        # if len(vad) > fea.shape[0]:
        #     vad=np.pad(vad, (0,fea.shape[0]-len(vad)), 'constant')
